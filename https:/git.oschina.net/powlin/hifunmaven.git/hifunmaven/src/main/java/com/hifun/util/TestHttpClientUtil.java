...
public class TestHttpClientUtil {
    ...
    public static void doSign(String username, String password) {
        ...
        NameValuePair[] data = { new NameValuePair("loginname", username),
                new NameValuePair("nloginpwd", password),
                new NameValuePair("uuid",
                    "f35283d8-c087-495a-88ce-e575c9aff178"),
                new NameValuePair("fp", "d7c43b4e1ba69bd6324a755dd412c829"),
                new NameValuePair("_t", "_ntMSHqs"),
                new NameValuePair("loginType", "f"),
                new NameValuePair("AluUZnKtsR", "vOywC") };
