	...
	<div class="middle-div minwid-div">
		...
		<div class="right-div">
			<div class="right-main-div">
				<ul class="normal-ul hibar-note-ul">
					<li class="hibar-note-li first-hibar-note-li">
						<a class="normal-a floatnone-a cursor-a user-link text-ellipsis display-inline">帖子1</a>
					</li>
					<li class="hibar-note-li">
						<a class="normal-a floatnone-a cursor-a user-link text-ellipsis display-inline">帖子2</a>
					</li>
					<li class="hibar-note-li">
						<a class="normal-a floatnone-a cursor-a user-link text-ellipsis display-inline">帖子3</a>
					</li>
					<li class="hibar-note-li">
						<a class="normal-a floatnone-a cursor-a user-link text-ellipsis display-inline">帖子4</a>
					</li>
					<li class="hibar-note-li">
						<a class="normal-a floatnone-a cursor-a user-link text-ellipsis display-inline">帖子5</a>
					</li>
					<li class="hibar-note-li">
						<a class="normal-a floatnone-a cursor-a user-link text-ellipsis display-inline">帖子6</a>
					</li>
					<li class="hibar-note-li">
						<a class="normal-a floatnone-a cursor-a user-link text-ellipsis display-inline">帖子7</a>
					</li>
					<li class="hibar-note-li">
						<a class="normal-a floatnone-a cursor-a user-link text-ellipsis display-inline">帖子8</a>
					</li>
				</ul>
			</div>
			<div>
				<button type="button" class="btn btn-primary">发 帖</button>
			</div>
		</div>
	</div>
</body>
