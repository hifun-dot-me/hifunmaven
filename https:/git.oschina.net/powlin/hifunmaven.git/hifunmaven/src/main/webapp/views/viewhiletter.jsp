...
<body class="inside-body no-scroll">
	<input id="base" type="hidden" value="<%=request.getContextPath()%>">
	<input id="usernameHid" type="hidden" value="${username}">
	<div class="body-div">
		<div class="letter-total-div">
			...
			<div class="letter-right-div">
				<div class="letter-content-div" id="message">
				...
				<div class="letter-btn-div">
					<c:if test="${!empty list}">
						<button id="sendBtn" class="btn btn-primary btn-send" onclick="sendletter(this)">发 送</button>
					</c:if>
